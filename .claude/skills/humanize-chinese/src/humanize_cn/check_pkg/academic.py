...
from .detect import detect_patterns as _general_detect
from .detect import calculate_score as _general_score
...
# Lazy import to avoid circular dependency (rewriting.humanize → detection.detect → ...)
_reduce_high_freq_bigrams = None
_randomize_sentence_lengths = None
_inject_noise_expressions = None
...
def humanize_academic(text, aggressive=False, seed=None, best_of_n=DEFAULT_BEST_OF_N):
    ...
    if best_of_n and best_of_n > 1:
        ...
        if compute_lr_score is None:
            return humanize_academic(text, aggressive=aggressive, seed=seed,
                                    best_of_n=None)
    ...
    if _reduce_high_freq_bigrams is None:
        ...
        _reduce_high_freq_bigrams = _rfb
        _randomize_sentence_lengths = _rsl
        _inject_noise_expressions = _ine

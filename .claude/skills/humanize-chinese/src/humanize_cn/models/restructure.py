...
def _init_bert():
    ...
    onnx_path = os.path.join(script_dir, '..', 'data', 'models', 'sentence_scorer', 'bert_base_chinese_mlm.onnx')
    # tokenizer 本地路径：data/ 目录
    tokenizer_local_path = os.path.join(script_dir, '..', 'data')

...
#   `.codex` [permissions] `deny_read` profile. See references/data-safety-runtime.md.
...
if [ ! -f "$GUARD" ]; then
  REASON="Scholar data-safety guard is missing from the self-contained auto-research runtime."

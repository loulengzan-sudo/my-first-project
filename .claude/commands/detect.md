...
Detect AI-generated patterns in Chinese text. Score 0-100, 20+ rule dimensions plus 8 HC3-calibrated statistical features.
...
2. Run detection with verbose mode:
   ```bash
   cd $SKILL_DIR && PYTHONPATH=src python3 -m humanize_cn.interfaces.cli detect /tmp/detect_input.txt -v
   ```
